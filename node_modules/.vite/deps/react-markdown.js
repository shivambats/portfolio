...
function all(values2, includeImageAlt, includeHtml) {
  ...
  while (++index3 < values2.length) {
    result[index3] = one2(values2[index3], includeImageAlt, includeHtml);
  }
  return result.join("");
}
function node(value) {
...
function normalizeUri(value) {
  ...
  while (++index3 < value.length) {
    ...
    let replace = "";
    if (code2 === codes.percentSign && asciiAlphanumeric(value.charCodeAt(index3 + 1)) && asciiAlphanumeric(value.charCodeAt(index3 + 2))) {
      skip = 2;
    } else if (code2 < 128) {
...
// node_modules/react-markdown/node_modules/unist-util-position/lib/index.js
...
// node_modules/react-markdown/node_modules/mdast-util-to-hast/lib/handlers/table-row.js
...
// node_modules/react-markdown/node_modules/mdast-util-to-hast/lib/handlers/table-cell.js
...
// node_modules/react-markdown/node_modules/mdast-util-to-hast/lib/state.js
